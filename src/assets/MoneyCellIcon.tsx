...
const MoneyCellIcon: React.FC<iconType> = ({ className, iconSize }) => {
  if (iconSize === 'm') {
    return (<svg width="240" height="40" viewBox="0 0 240 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill="white" stroke="#D0D0D8" className={className}/>
      </svg>)
  } else if (iconSize === 's') {
    return (<svg width="240" height="32" viewBox="0 0 240 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
